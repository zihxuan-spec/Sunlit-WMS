...
export default function App() {
  ...
  // Render -----------------------------
  if (!currentUser) return <><Login onLogin={setCurrentUser} t={t} lang={lang} setLang={setLang} showAlert={showAlert} /><GlobalModal modal={modal} closeModal={closeModal} t={t} /></>;
