...
export default function App() {
  ...
  const handlePickAllFound = () => {
    ...
    showConfirm(t.msgShipConfirm.replace('{n}', outboundPending.length), async () => {
      ...
      // Mark corresponding turnover_inventory records as shipped
  ...
  return (
    <div className="app-shell">
      ...
      <div className="main-content">
        ...
        {currentView === 'turnover'  && <Turnover t={t} lang={lang} currentUser={currentUser} turnoverItems={turnoverItems} fetchTurnover={fetchTurnover} showAlert={showAlert} showConfirm={showConfirm} setOutboundAssignItems={setOutboundAssignItems} setCurrentView={setCurrentView} setActiveWarehouse={setActiveWarehouse} />}
