...
const NAV_ITEMS = {
 ...
 { key: 'inbound', icon: 'IN', label: { en: 'Inbound', zh: '入庫' } },
 { key: 'turnover', icon: 'TV', label: { en: 'Turnover', zh: '週轉' } },
 { key: 'outbound', icon: 'OUT', label: { en: 'Outbound', zh: '出庫' } },
 { key: 'map', icon: 'MAP', label: { en: 'Map', zh: '地圖' } },
 { key: 'zebra', icon: 'ZBR', label: { en: 'Zebra', zh: '掃描' } },
 ],
 production: [
 { key: 'mes', icon: 'MES', label: { en: 'MES', zh: 'MES' } },
 { key: 'reusable', icon: 'RCY', label: { en: 'Reusable', zh: '循環' } },
 ],
};

const DOT_COLORS = {
 dashboard: '#3b82f6', inbound: '#6b7280', turnover: '#f59e0b',
 outbound: '#6b7280', map: '#6b7280',
...
export default function Navbar({ currentUser, userRole, handleLogout, lang, setLang, currentView, setCurrentView, t, theme, toggleTheme }) {
 ...
 <div className="tab-icon-wrap">OUT</div>
