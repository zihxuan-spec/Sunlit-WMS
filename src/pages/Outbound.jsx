...
export default function Outbound({
  ...
  const handleConfirmShip = () => {
    ...
    handlePickAllFound(customerName.trim());
  };
        ...
        <div className="modal-overlay">
          <div className="modal-card" style={{ maxWidth: 420 }}>
            ...
            <div className="modal-actions">
              ...
              <button className="btn btn-danger" disabled={!customerName.trim()} onClick={handleConfirmShip}>
        ...
        <div className="card" style={{ border: '1px solid var(--dk-danger)', marginBottom: 14 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button className="btn btn-danger btn-sm" onClick={handleShipClick}>{t.btnShipAll}</button>
            </div>
          </div>
