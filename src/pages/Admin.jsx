...
export default function Admin({ lang, showAlert, showConfirm }) {
  ...
  return (
    <div>
      ...
      {tab === 'employees'  && <EmployeesTab  lang={lang} L={L} showAlert={showAlert} showConfirm={showConfirm} />}
...
// Tab 3: Employees
// ════════════════════════════════════════════════════════════
function EmployeesTab({ lang, L, showAlert, showConfirm }) {
  ...
  const del = (e) => showConfirm(L(`Delete employee "${e.name}"?`,`確定刪除員工「${e.name}」？`), async () => {
